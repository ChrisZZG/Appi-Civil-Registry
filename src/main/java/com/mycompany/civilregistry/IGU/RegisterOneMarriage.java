 ...
 * @author crist
 */
public class RegisterOneMarriage extends javax.swing.JFrame {

    //INSTANCIAS Y VARIABLES GLOBALES
    Controladora control = null;
    
    public RegisterOneMarriage() {
    ...
    private void initComponents() {
        ...
        btnCleanRegistry.setText("CLEAN REGISTRY");
        ...
        btnSaveRegistry.setText("SAVE REGISTRY");
    ...
    private void btnSaveRegistryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveRegistryActionPerformed
        ...
        //LLAMO A LA CONTROLADORA Y LE PASO LOS DATOS QUE QUIERO GUARDAR EN UN SOLO METODO
        control.save(nameHusband, lastNameHusband, dniHusband, birthdateHusband, nameWife, lastNameWife, dniWife, birthdateWife);
        
        //NOTIFICACION DE GUARDADO CORRECTO
        JOptionPane optionPane = new JOptionPane("SAVE SUCCESS");
